Feature: Horizon Services Plumbing Drains & Sewer Lines page tests

  @Regression
  Scenario: Validate Book Now, call button, explore membership button in Drains & Sewer Lines page
    Given I navigate to "https://test.horizonservices.com"
    When I Click on Plumbing
    When I click on "Drains & Sewer Lines" button in category header submenu
  ...
  @Smoke
  Scenario: Validate Offer at the bottom of the Drains and Sewer Lines Page
    Given I navigate to "https://test.horizonservices.com/"
    When I Click on Plumbing
    When I click on "Drains & Sewer Lines" button in category header submenu
