Feature: Horizon Services Plumbing Gas Lines page tests

  Scenario: Validate Book Now, call button, explore membership button in Gas Lines page
    Given I navigate to "https://test.horizonservices.com"
    When I Click on Plumbing
    When I click on "Gas Lines" button in category header submenu
  ...
  Scenario: Validate Offer at the bottom of the Gas Lines Page
    Given I navigate to "https://test.horizonservices.com/"
    When I Click on Plumbing
    When I click on "Gas Lines" button in category header submenu
