Feature: Learn More Electrical PLP page scenarios

  Scenario: Navigate to Learn More Electrical PLP page and Verify Book Now and call buttons in image, Google review, Explore Financing
    Given I navigate to "https://test.horizonservices.com/learn-more/electrical"
  ...
  Scenario: Validate all bottom CTAs and detail links in Learn More Electrical PLP
    Given I navigate to "https://test.horizonservices.com/learn-more/electrical"
