Feature: Horizon Services Electrical Whole-House Surge Protectors page tests

  Scenario: Validate Book Now, call button, explore membership button in Whole-House Surge Protectors page
    Given I navigate to "https://test.horizonservices.com"
    When I Click on Electrical
    When I click on "Whole-House Surge Protectors" button in category header submenu
...
#    Then I can verify Phone call popup
  ...
  Scenario: Validate Offer at the bottom of the Whole House Surge Protectors Page
    Given I navigate to "https://test.horizonservices.com/"
    When I Click on Electrical
    When I click on "Whole-House Surge Protectors" button in category header submenu
